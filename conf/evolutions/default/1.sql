...
create table "Tournaments" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"display_name" VARCHAR NOT NULL,"tourney_type" VARCHAR NOT NULL);
create unique index "idx_name" on "Tournaments" ("name");
